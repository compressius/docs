---
title: "Update CMX to the Latest Version"
sidebarTitle: "Updates"
description: "How to check for and install CMX updates using the upgrade command or by re-running your original package manager install."
---
...
This downloads the verified update and installs it in place. You do not need to uninstall your current version first. After installation, restart CMX with `cmx stop` followed by `cmx start` to run the new version.
...
Full release notes for every stable build are available at [compressi.us/changelog](https://compressi.us/changelog). Every release, including nightlies, is listed on the [GitHub releases page](https://github.com/compressius/cmx/releases).
