---
title: "Compressius Maximus (CMX): What It Is and How It Works"
sidebarTitle: "Introduction"
description: "Learn what CMX is, the token-cost problem it solves, how model-directed compression works, and which coding agents and providers it supports."
keywords:
  - "what is CMX"
  - "Compressius Maximus"
...
Provider credentials are held in memory for the lifetime of the gateway process and are never written to disk. CMX runs fully locally without a CMX account; in that mode only anonymous aggregate counters are sent, and they never appear in a dashboard. If you sign in, the same aggregate counters — totals of tokens handled and saved, with no attached content — are associated with your account and shown on the web dashboard.

<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Install CMX and connect your coding agent in four steps. No CMX account required.
  </Card>
