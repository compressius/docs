...
<Note>
  After installing, run `cmx setup` and choose **Continue locally** to start the gateway without a CMX account, or **Sign in** to also pair the installation with the web dashboard. See the [Quick Start](/quickstart) guide for a full walkthrough.
</Note>
