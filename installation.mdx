...
The command restores your coding agents to their direct connections, stops the gateway, removes background services, and deletes CMX configuration, data, and the executable. See [Uninstall](/uninstall) for flags and the platform-specific manual purge fallback.
