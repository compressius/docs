...
- **Session length**: Compression only activates above `min_context_tokens` (default: 1,000 tokens). The longer a session runs, the more repetitive context accumulates and the more CMX can summarize away.
