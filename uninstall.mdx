...
description: "Complete guide to removing CMX: restore coding-agent routing, stop the gateway, wipe all data, and verify nothing is left behind on any platform."
---
