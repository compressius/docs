...
CMX works with any coding agent or tool that accepts a custom API base URL and speaks OpenAI Chat Completions, OpenAI Responses, or Anthropic Messages. The following agents are first-class integrations with dedicated setup guides and automated harness patching via `cmx harness enable <name>`:

- [Codex](/providers/codex)
- [OpenCode](/providers/opencode)
- [Claude Code](/providers/claude-code)
- [Aider](/providers/aider)
- [Cline](/providers/cline)
- [Antigravity (`agy`)](/providers/antigravity)

Other tools are not individually verified, but many work with CMX without any changes beyond pointing them at the local gateway.
