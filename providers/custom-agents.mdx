---
title: "Connect Any OpenAI or Anthropic Agent to CMX"
sidebarTitle: "Custom Agents"
description: "Use CMX with any AI coding tool that accepts a custom API base URL and speaks OpenAI or Anthropic protocols."
---
