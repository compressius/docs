---
title: "CMX Release Notes and Changelog"
...
- Startup repairs missing compression request identifiers using a consistent SQLite backup without deleting usage, session, or compression history.
